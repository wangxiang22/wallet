...
public class RedisClient {
    ...
    public void setDay(String key,Object value,long dayNumber){
        template.opsForValue().set(key,value,dayNumber,TimeUnit.DAYS);
    }
    ...
    public void hashAll(String key , Map m){
     ...
     * @return
     */
    public Boolean hashHexists(String key, Object hashKey){
