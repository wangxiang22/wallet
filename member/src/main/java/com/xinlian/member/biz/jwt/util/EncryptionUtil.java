...
public class EncryptionUtil {
    ...
    public static boolean checkMd5Pwd(String dbPwd,String salt,String requestPwd){
        return dbPwd.equals(EncryptionUtil.md5Two(requestPwd, salt));
    }

    public static String getRandomCode(int length) {
        if(isTest){return "123456";}
    ...
    public static void main(String[] args){
        ...
        System.out.println(md5Two("jiii", "gsjah21"));
    }
}
